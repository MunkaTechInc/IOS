...
class MNFreelauncerMyJobsVC: UIViewController,getJobType {
...
// MARK: - extension
extension MNFreelauncerMyJobsVC: UITableViewDataSource,UITableViewDelegate{
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if indexPath.row == self.objIndividual.count {
            ...
            cell = tableView.dequeueReusableCell(withIdentifier: "MyjobsTableViewCell", for: indexPath) as? MyjobsTableViewCell
             cell?.imgMyjobs.sd_setImage(with: URL(string:img_BASE_URL + self.objIndividual[indexPath.row].freelancerProfilePic), placeholderImage:#imageLiteral(resourceName: "phl_circle_profile.png"))
