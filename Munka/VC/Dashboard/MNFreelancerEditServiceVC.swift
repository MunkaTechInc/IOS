//
//  MNFreelancerEditServiceVC.swift
//  Munka
//
//  Created by Amit on 08/05/20.
...
class MNFreelancerEditServiceVC: UIViewController,GetSelectCategoryOnPostJob,UIImagePickerControllerDelegate, UINavigationControllerDelegate {
   ...
   override func viewDidLoad() {
    ...
    if documentImage.isEmpty {
        ...
        self.btnClose.isHidden = true
        self.imgview.sd_setImage(with: URL(string:img_BASE_URL + self.documentImage), placeholderImage:#imageLiteral(resourceName: "ic_category_img"))
...
//        self.viewimageHight.constant = 0
   ...
   func callServicEditCategoryAPI(servicecategoryid:String) {
       ...
       HTTPService.callForProfessinalUploadMultipleImage(url: editServiceAPI, imageToUpload: self.arrayImages, parameters: parameter){ (response) in
                       // HideHud()
            HideHud(view: self.view)
   ...
   func imagePickerController(_ picker: UIImagePickerController, didFinishPickingMediaWithInfo info: [UIImagePickerController.InfoKey : Any]) {
      ...
      func imagePickerControllerDidCancel(_ picker: UIImagePickerController){
         ...
         extension MNFreelancerEditServiceVC: UIDocumentPickerDelegate {
