//
//  ModelindividualPaymentDetails.swift
//  Munka
//
...
import Foundation
class ModelindividualPaymentDetails : NSObject, NSCoding{
    ...
    init(fromDictionary dictionary: [String:Any]){
        ...
        if let detailsData = dictionary["details"] as? [String:Any]{
            details = ModelIndividualPaymentDetail(fromDictionary: detailsData)
        }
    }
    ...
    {
        details = aDecoder.decodeObject(forKey: "details") as? ModelIndividualPaymentDetail
...
class ModelIndividualPaymentDetail : NSObject, NSCoding{
