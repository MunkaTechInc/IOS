...
import Foundation
class ModelIndividualHome : NSObject, NSCoding{

    var details : [ModelIndividualDetail]!
    var msg : String!
    var status : String!
    ...
    init(fromDictionary dictionary: [String:Any]){
        ...
        details = [ModelIndividualDetail]()
        if let detailsArray = dictionary["details"] as? [[String:Any]]{
            for dic in detailsArray{
                let value = ModelIndividualDetail(fromDictionary: dic)
    ...
    {
        details = aDecoder.decodeObject(forKey: "details") as? [ModelIndividualDetail]
...
class ModelIndividualDetail : NSObject, NSCoding{
    ...
    var serviceCategoryTitle : String!
    var state : String!
    var status : String!
    ...
    init(fromDictionary dictionary: [String:Any]){
        ...
        serviceCategoryTitle = dictionary["service_category_title"] as? String
    ...
    func toDictionary() -> [String:Any]
    {
        ...
        if serviceCategoryTitle != nil{
            dictionary["service_category_title"] = serviceCategoryTitle
        }
        if state != nil{
    ...
    @objc required init(coder aDecoder: NSCoder)
    {
        ...
        serviceCategoryTitle = aDecoder.decodeObject(forKey: "service_category_title") as? String
        ...
        workerCategory = aDecoder.decodeObject(forKey: "worker_category") as? [ModelWorkerCategory]
    }
    ...
    @objc func encode(with aCoder: NSCoder)
    {
        ...
        if serviceCategoryTitle != nil{
            aCoder.encode(serviceCategoryTitle, forKey: "service_category_title")
        }
        if state != nil{
...
class ModelWorkerCategory : NSObject, NSCoding{
