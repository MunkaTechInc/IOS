//
//  ModelIndividualProgressJoblist.swift
//  Munka
//
...
import Foundation
class ModelIndividualProgressJoblist : NSObject, NSCoding{

    var details : [ModelIndividualProgressDetail]!
    var msg : String!
    var status : String!
    ...
    init(fromDictionary dictionary: [String:Any]){
        ...
        details = [ModelIndividualProgressDetail]()
        if let detailsArray = dictionary["details"] as? [[String:Any]]{
            for dic in detailsArray{
                let value = ModelIndividualProgressDetail(fromDictionary: dic)
    ...
    {
        details = aDecoder.decodeObject(forKey: "details") as? [ModelIndividualProgressDetail]
...
class ModelIndividualProgressDetail : NSObject, NSCoding{
    ...
    var seviceCategoryTitle : String!
    var status : String!
    var timeDuration : String!
    var timeSpand : String!
    var urgentFill : String!
    var workedBy : String!
    var workerCategory : [ModelWorkerIndividualCategory]!
    ...
    init(fromDictionary dictionary: [String:Any]){
        ...
        seviceCategoryTitle = dictionary["sevice_category_title"] as? String
        status = dictionary["status"] as? String
        ...
        workerCategory = [ModelWorkerIndividualCategory]()
        if let workerCategoryArray = dictionary["worker_category"] as? [[String:Any]]{
            for dic in workerCategoryArray{
                let value = ModelWorkerIndividualCategory(fromDictionary: dic)
                workerCategory.append(value)
            }
        }
    }
    ...
    func toDictionary() -> [String:Any]
    {
        ...
        if seviceCategoryTitle != nil{
            dictionary["sevice_category_title"] = seviceCategoryTitle
        }
        if status != nil{
            dictionary["status"] = status
        }
        ...
        if workerCategory != nil{
            var dictionaryElements = [[String:Any]]()
            for workerCategoryElement in workerCategory {
                dictionaryElements.append(workerCategoryElement.toDictionary())
            }
            dictionary["workerCategory"] = dictionaryElements
        }
        return dictionary
    }
    ...
    @objc required init(coder aDecoder: NSCoder)
    {
        ...
        seviceCategoryTitle = aDecoder.decodeObject(forKey: "sevice_category_title") as? String
        status = aDecoder.decodeObject(forKey: "status") as? String
        ...
        workerCategory = aDecoder.decodeObject(forKey: "worker_category") as? [ModelWorkerIndividualCategory]
    }
    ...
    @objc func encode(with aCoder: NSCoder)
    {
        ...
        if seviceCategoryTitle != nil{
            aCoder.encode(seviceCategoryTitle, forKey: "sevice_category_title")
        }
        if status != nil{
            aCoder.encode(status, forKey: "status")
        }
        ...
        if workerCategory != nil{
            aCoder.encode(workerCategory, forKey: "worker_category")
        }
    }
}


class ModelWorkerIndividualCategory : NSObject, NSCoding{
