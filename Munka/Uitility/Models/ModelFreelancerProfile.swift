...
import Foundation
class ModelFreelancerProfile : NSObject, NSCoding{

    var details : ModelFreelancerProfileDetail!
    var msg : String!
    var status : String!
    ...
    init(fromDictionary dictionary: [String:Any]){
        ...
        if let detailsData = dictionary["details"] as? [String:Any]{
            details = ModelFreelancerProfileDetail(fromDictionary: detailsData)
        }
    }
    ...
    {
        details = aDecoder.decodeObject(forKey: "details") as? ModelFreelancerProfileDetail
...
class ModelFreelancerProfileDetail : NSObject, NSCoding{
