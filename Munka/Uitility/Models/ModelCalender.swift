...
import Foundation
class ModelCalender : NSObject, NSCoding{
    
    var jobList : [ModelCalenderJobList]!
    var msg : String!
    var status : String!
    ...
    init(fromDictionary dictionary: [String:Any]){
        ...
        jobList = [ModelCalenderJobList]()
        if let jobListArray = dictionary["job_list"] as? [[String:Any]]{
            for dic in jobListArray{
                let value = ModelCalenderJobList(fromDictionary: dic)
    ...
    {
        jobList = aDecoder.decodeObject(forKey: "job_list") as? [ModelCalenderJobList]
...
class ModelCalenderJobList : NSObject, NSCoding{
