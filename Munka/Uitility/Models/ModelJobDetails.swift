class ModelJobDetails : NSObject, NSCoding{
    ...
    init(fromDictionary dictionary: [String:Any]){
        ...
        if let detailsData = dictionary["details"] as? [String:Any]{
            details = ModelJobDetail(fromDictionary: detailsData)
        }
    }
    ...
    {
        details = aDecoder.decodeObject(forKey: "details") as? ModelJobDetail
...
class ModelJobDetail : NSObject, NSCoding{
    ...
    init(fromDictionary dictionary: [String:Any]){
        ...
        if let hourlyJobTimeArray = dictionary["hourly_job_time"] as? [[String:Any]]{
            for dic in hourlyJobTimeArray{
                let value = ModelHourlyJobTime(fromDictionary: dic)
    ...
    @objc required init(coder aDecoder: NSCoder)
    {
        ...
        hourlyJobTime = aDecoder.decodeObject(forKey: "hourly_job_time") as? [ModelHourlyJobTime]
    ...
    @objc func encode(with aCoder: NSCoder)
    {
        ...
        if state != nil{
            aCoder.encode(workedBy, forKey: "state")
        }
    }
}
class ModelHourlyJobTime : NSObject, NSCoding{
