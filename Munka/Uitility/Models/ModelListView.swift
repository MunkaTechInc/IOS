...
import Foundation
class ModelListView : NSObject, NSCoding{

    var details : [ModelListViewDetail]!
    var msg : String!
    var status : String!
    ...
    init(fromDictionary dictionary: [String:Any]){
        ...
        details = [ModelListViewDetail]()
        if let detailsArray = dictionary["details"] as? [[String:Any]]{
            for dic in detailsArray{
                let value = ModelListViewDetail(fromDictionary: dic)
    ...
    {
        details = aDecoder.decodeObject(forKey: "details") as? [ModelListViewDetail]
...
class ModelListViewDetail : NSObject, NSCoding{
    ...
    init(fromDictionary dictionary: [String:Any]){
        ...
        workerCategory = dictionary["worker_category"] as? String
    }
    ...
    func toDictionary() -> [String:Any]
    {
        ...
        if workerCategory != nil{
            dictionary["worker_category"] = workerCategory
        }
        return dictionary
    }
    ...
    @objc required init(coder aDecoder: NSCoder)
    {
        ...
        workerCategory = aDecoder.decodeObject(forKey: "worker_category") as? String
    }
