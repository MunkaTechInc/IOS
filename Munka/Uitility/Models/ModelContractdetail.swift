...
class ModelContractdetail : NSObject, NSCoding{

    var details : ModelContactDetail!
    var msg : String!
    var status : String!
    ...
    init(fromDictionary dictionary: [String:Any]){
        ...
        if let detailsData = dictionary["details"] as? [String:Any]{
            details = ModelContactDetail(fromDictionary: detailsData)
        }
    }
    ...
    {
        details = aDecoder.decodeObject(forKey: "details") as? ModelContactDetail
...
class ModelContactDetail : NSObject, NSCoding{

    var appliedBy : String!
    var budgetAmount : String!
    var contractHourlyJobTime : [ModelContractHourlyJobTime]!
    var created : String!
    var endDate : String!
    ...
    init(fromDictionary dictionary: [String:Any]){
        ...
        contractHourlyJobTime = [ModelContractHourlyJobTime]()
        if let contractHourlyJobTimeArray = dictionary["contract_hourly_job_time"] as? [[String:Any]]{
            for dic in contractHourlyJobTimeArray{
                let value = ModelContractHourlyJobTime(fromDictionary: dic)
                contractHourlyJobTime.append(value)
            }
        }
    }
    ...
    func toDictionary() -> [String:Any]
    {
        ...
        if contractHourlyJobTime != nil{
            var dictionaryElements = [[String:Any]]()
            for contractHourlyJobTimeElement in contractHourlyJobTime {
                dictionaryElements.append(contractHourlyJobTimeElement.toDictionary())
            }
            dictionary["contractHourlyJobTime"] = dictionaryElements
        }
        return dictionary
    }
    ...
    @objc required init(coder aDecoder: NSCoder)
    {
        ...
        contractHourlyJobTime = aDecoder.decodeObject(forKey: "contract_hourly_job_time") as? [ModelContractHourlyJobTime]
    ...
    @objc func encode(with aCoder: NSCoder)
    {
        ...
        if contractHourlyJobTime != nil{
            aCoder.encode(contractHourlyJobTime, forKey: "contract_hourly_job_time")
        }
        if created != nil{
...
class ModelContractHourlyJobTime : NSObject, NSCoding{
