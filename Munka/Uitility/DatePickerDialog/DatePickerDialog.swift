...
open class DatePickerDialog: UIView {
    ...
    public init(textColor: UIColor = UIColor.black,
                buttonColor: UIColor = #colorLiteral(red: 0.1240559593, green: 0.2075027227, blue: 0.5526501536, alpha: 1),
    ...
    func setupView() {
        ...
        NSLayoutConstraint.activate([
            datePicker.centerXAnchor.constraint(equalTo: self.dialogView!.centerXAnchor),
            datePicker.centerYAnchor.constraint(equalTo: self.dialogView!.centerYAnchor)
        ])
    }
    ...
    open func show(controller:UIViewController?,_ title: String,
