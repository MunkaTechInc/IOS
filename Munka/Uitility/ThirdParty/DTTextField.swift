...
public class DTTextField: UITextField {
    ...
    @IBInspectable public var DTplaceholderColor: UIColor = UIColor.clear {
            didSet {
        ...
        @IBInspectable public var DTborderColor: UIColor = UIColor.clear {
            didSet {
                layer.borderColor = DTborderColor.cgColor
            }
        }
